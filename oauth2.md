...
| okta.roles.manage     | Allows the app to manage administrative role assignments for clients in your Okta org |
| okta.roles.read       | Allows the app to read administrative role assignments for clients in your Okta org |
